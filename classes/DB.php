	...
	abstract class DB
	{
		public static function getAllMovies()
		{
			...
			$stmt = $connection->prepare("
				...
				ORDER BY m.title;
			");
			// En el select debería cambiar ese movie_id pero no sé bien cómo. PREGUNTAR
...
// agregué el id dentro del constructo y arreglé el setGenreId que conectaba con el movieID
				$finalMovie->setId($movie['movie_id']);
				$finalMovie->setLength($movie['length']);
				$finalMovie->setGenreID($movie['genre_id']);
				// cambié a genre_id porque que estaba conectado a movie_id
...
// Agregué el método para obtener los actores
